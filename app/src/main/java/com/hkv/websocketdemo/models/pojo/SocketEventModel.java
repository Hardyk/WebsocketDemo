package com.hkv.websocketdemo.models.pojo;


import com.hkv.websocketdemo.DemoApp;
import com.hkv.websocketdemo.models.BaseModel;
...
public class SocketEventModel extends BaseModel {
    ...
    public String getPayloadAsString() {
        String payloadJson = DemoApp.getGson().toJson(payload);
    ...
    public <T>T payloadToJson(Class<T>typeOf) {
        return DemoApp.getGson().fromJson(getPayloadAsString(), typeOf);
    }
